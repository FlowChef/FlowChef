...
for dataset in "AFHQ-Cat" "CelebA"; do
    for problem in "box_inpaint" "super_resolution" "deblur"; do
        ...
        (
            CUDA_VISIBLE_DEVICES=$gpu python generate_inverseproblems_otode.py --gpu 0 \
                --solver euler --N 100 --sampler new --batchsize 1 \
                --ckpt ./checkpoints/${ckpt} \
                --config configs_unet/${config} \
                --input_dir ./data/${dataset} \
                --dir outputs/otode/inverseproblems/N100_${dataset,,}_${problem} \
        ...
        for noise in 0.0 0.05; do
            ...
            (
                CUDA_VISIBLE_DEVICES=$gpu python generate_inverseproblems_otode.py --gpu 0 \
                    ...
                    --config configs_unet/${config} \
                    --input_dir ./data/${dataset} \
                    --dir outputs/otode/inverseproblems/N200_${dataset,,}_box_inpaint_m${mask_size}_n${noise} \
        ...
        for noise in 0.0 0.05; do
            ...
            (
                CUDA_VISIBLE_DEVICES=$gpu python generate_inverseproblems_otode.py --gpu 0 \
                    ...
                    --config configs_unet/${config} \
                    --input_dir ./data/${dataset} \
                    --dir outputs/otode/inverseproblems/N200_${dataset,,}_super_resolution_s${scale}_n${noise} \
        ...
        for noise in 0.0 0.05; do
            ...
            (
                CUDA_VISIBLE_DEVICES=$gpu python generate_inverseproblems_otode.py --gpu 0 \
                    ...
                    --config configs_unet/${config} \
                    --input_dir ./data/${dataset} \
                    --dir outputs/otode/inverseproblems/N200_${dataset,,}_deblur_k${kernel}_n${noise} \
...
# CUDA_VISIBLE_DEVICES=0 python generate_inverseproblems_otode_time.py --gpu 0 \
#     --solver euler --N 200 --sampler new --batchsize 1 \
#     --ckpt ./checkpoints/afhq-configF.pth \
#     --config configs_unet/afhq64_ve_aug.json \
#     --input_dir ./data/AFHQ-Cat \
#     --dir outputs/otode/inverseproblems/test_run \
#     --inverse_problem "deblur" --noise_sigma 0.0 \
#     --kernel_size 11 --blur_sigma 1.0
