...
for dataset in "AFHQ-Cat" "CelebA"; do
    for problem in "box_inpaint" "super_resolution" "deblur"; do
        ...
        (
            CUDA_VISIBLE_DEVICES=$gpu python generate_inverseproblems_freedom.py --gpu 0 \
                --solver euler --N 50 --sampler new --batchsize 1 \
                --ckpt ./checkpoints/${ckpt} \
                --config configs_unet/${config} \
                --input_dir ./data/${dataset} \
                --dir outputs/dps/inverseproblems/N100_${dataset,,}_${problem} \
        ...
        for noise in 0.0 0.05; do
            ...
            (
                CUDA_VISIBLE_DEVICES=$gpu python generate_inverseproblems_freedom.py --gpu 0 \
                    ...
                    --config configs_unet/${config} \
                    --input_dir ./data/${dataset} \
                    --dir outputs/dps/inverseproblems/N200_${dataset,,}_box_inpaint_m${mask_size}_n${noise} \
        ...
        for noise in 0.0 0.05; do
            ...
            (
                CUDA_VISIBLE_DEVICES=$gpu python generate_inverseproblems_freedom.py --gpu 0 \
                    ...
                    --config configs_unet/${config} \
                    --input_dir ./data/${dataset} \
                    --dir outputs/dps/inverseproblems/N200_${dataset,,}_super_resolution_s${scale}_n${noise} \
        ...
        for noise in 0.0 0.05; do
            ...
            (
                CUDA_VISIBLE_DEVICES=$gpu python generate_inverseproblems_freedom.py --gpu 0 \
                    ...
                    --config configs_unet/${config} \
                    --input_dir ./data/${dataset} \
                    --dir outputs/dps/inverseproblems/N200_${dataset,,}_deblur_k${kernel}_n${noise} \
...
# CUDA_VISIBLE_DEVICES=0 python generate_inverseproblems_freedom.py \
#     --gpu 0 \
#     --solver euler \
#     --N 100 \
#     --sampler new \
